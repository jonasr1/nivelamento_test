...
class ZipCompressor:
    def __init__(self, output_folder: str | Path = "") -> None:
        ...
        Args:
            ...
            Se não for fornecido, o diretório padrão será:
            "testes/web_scraping/compressed_files"
        '''
        self.output_folder = (
            Path(output_folder)
            if output_folder
            else Path(__file__).parent.parent / 'compressed_files'
        )
